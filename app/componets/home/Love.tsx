  ...
  return (
    <div className="mt-[100px] p-[0_20px_0_20px] mb-[100px]">
      <div className="flex justify-center items-center  max-sm:mb-[10px]">
        ...
        <p className="w-[100px] font-bold text-[20px] text-[#ccc] underline underline-[#333] underline-offset-4 max-sm:text-[15px] max-sm:text-[#ccc] max-sm:w-[70px]">
          + MORE
        </p>
      </div>
          ...
          if (i === 1 || i === 2 || i === 3) {
            return (
              ...
              >
                ...
                />
                <strong className="w-[290px] text-[20px] text-[#d7000f] font-bold max-sm:text-[15px] max-sm:mt-[5px]">
                  {article.category}
                </strong>
                <h2 className="w-[290px] leading-[30px] text-[#ddd] text-[24px] font-medium max-md:text-[20px] max-md:w-[240px] max-sm:w-[100%] max-sm:text-[18px] max-sm:truncate">
                  {article.title}
                </h2>
              </li>
            );
